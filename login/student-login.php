...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $query = "SELECT * FROM users WHERE username = '$username' AND role = 2";
  ...
  if (mysqli_num_rows($result) == 1) {
    ...
    if ($input_password == $password) {
      ...
      // Chuyển hướng đến trang class.php
  ...
  <div id="login-wrapper">
    ...
    <a href="../" class="logo" style="text-decoration: none; font-family: Lobster, sans-serif">
      ...
      <div class="role">
        ...
        <div class="drop-down">
          <ul>
            <li><a href="#">Tôi là học sinh</a></li>
            <li><a href="teacher-login.php">Tôi là giáo viên</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <form action="" method="post">
      <div class="content">
        <div>
          <h2 style="margin: 0;">Học sinh đăng nhập</h2>
        </div>
        <div class="input">
          <div class="username"><input type="text" name="username" placeholder="Email/Số điện thoại"></div>
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] == "POST" && $invalidLogin): ?>
          <div class="error-message" style="margin-top: 48px; color: red;">Thông tin đăng nhập không chính xác</div>
        <?php endif; ?>
